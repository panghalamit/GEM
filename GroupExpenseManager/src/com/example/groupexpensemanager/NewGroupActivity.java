...
public class NewGroupActivity extends Activity {
	...
	public void addMember(View v) {
		...
		tv.setText("Member " + numberMembers);
		...
		if (numberMembers > 2) {
			ImageButton ibRemove = (ImageButton) findViewById(numberMembers+99);
			tl.removeView(ibRemove);
		}
